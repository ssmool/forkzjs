...
if[[ "$forkz_media" =~ [Yy] ]]; then
	...
	python forkz_vision.py
	echo"Welcome to FORKZ comix - create a library with images online:"
	python forkz_comix.py
	echo"Welcome to FORKZ VISION - create a library with audio online:"
	python forkz_ogg.py
# ---
